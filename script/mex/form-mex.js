...
$(function () {
    $('#form-sug-nuevo-local').on('submit', function (e) {
        ...
        if (validateRecaptcha(recaptcha1) === true) {
            $.ajax({
                type: 'post',
                url: 'https://buscatuarepa.com/php/mex/form-sug-nuevo-local-mex.php',
...
$(function () {
    $('#form-sug-nuevo-delivery').on('submit', function (e) {
        ...
        if (validateRecaptcha(recaptcha2) === true) {
            $.ajax({
                type: 'post',
                url: 'https://buscatuarepa.com/php/mex/form-sug-nuevo-delivery-mex.php',
...
$(function () {
    $('#form-sug-edicion').on('submit', function (e) {
        ...
        if (validateRecaptcha(recaptcha3) === true) {
            $.ajax({
                type: 'post',
                url: 'https://buscatuarepa.com/php/mex/form-sug-edicion-mex.php',
