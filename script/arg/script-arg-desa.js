...
$(document).ready(function () {
    ...
    var searchBoxExtend = L.Control.extend({
        ...
        update: function (d) {
            this._div.innerHTML = "<input type='text' class='typeahead tt-query' autocomplete='off' spellcheck='false' placeholder='Que quieres encontrar?'>";
        }
    });
    ...
    $(".typeahead").bind("typeahead:select", function (ev, suggestion) {
        ...
        $.each(deliveryData, function (index, object) {
            if (object.NAVIDAD && object.NAVIDAD.includes(suggestion)) {
        ...
        $.each(localesData.features, function (index, object) {
            if (object.properties.NAVIDAD && object.properties.NAVIDAD.includes(suggestion)) {
...
function getDataLocales() {
    $.ajax("./php/arg/consulta-locales-arg-desa.php", {
...
function getDataDelivery() {
    $.ajax("./php/arg/consulta-delivery-arg.php", {
