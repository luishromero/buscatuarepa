...
$(function () {
    $('#form-sug-nuevo-local').on('submit', function (e) {
        ...
        if (validateRecaptcha(recaptcha1) === true) {
            $.ajax({
                type: 'post',
                url: 'https://buscatuarepa.com/php/chl/form-sug-nuevo-local-chl.php',
...
$(function () {
    $('#form-sug-nuevo-delivery').on('submit', function (e) {
        ...
        if (validateRecaptcha(recaptcha2) === true) {
            $.ajax({
                type: 'post',
                url: 'https://buscatuarepa.com/php/chl/form-sug-nuevo-delivery-chl.php',
...
$(function () {
    $('#form-sug-edicion').on('submit', function (e) {
        ...
        if (validateRecaptcha(recaptcha3) === true) {
            $.ajax({
                type: 'post',
                url: 'https://buscatuarepa.com/php/chl/form-sug-edicion-chl.php',
