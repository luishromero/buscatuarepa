...
$(function () {
  $("#form-sug-nuevo-local").on("submit", function (e) {
    ...
    $.ajax({
      type: "post",
      url: "http://localhost:8181/php/chl/form-sug-nuevo-local-chl.php",
...
$(function () {
  $("#form-sug-nuevo-delivery").on("submit", function (e) {
    ...
    $.ajax({
      type: "post",
      url: "http://localhost:8181/php/chl/form-sug-nuevo-delivery-chl.php",
...
$(function () {
  $("#form-sug-edicion").on("submit", function (e) {
    ...
    $.ajax({
      type: "post",
      url: "http://localhost:8181/php/chl/form-sug-edicion-chl.php",
